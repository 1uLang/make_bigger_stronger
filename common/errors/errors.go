 ...
 * LastEditTime: 2023-04-23 14:55:31
...
func ParamsError() error {
	return NewErrCodeMsg(ErrCodeReqParam, "参数错误")
}
...
func RoleAddRepatedError() error {
	return NewErrCode(ErrCodeRoleAddRepeated)
}
...
func ValidateIpError() error {
	return NewErrCode(ErrCodeValidateIp)
}
