 ...
 * LastEditTime: 2023-04-25 10:32:27
 * @FilePath: /zero-trust/console/IAM/common/errors/vars.go
 */
...
var ErrMap = map[string]map[int32]string{
	"zh": {
		...
		ErrCodeRoleAddRepeated:           "新增角色失败,存在同名属性",
	...
	"en": {
		...
		ErrCodeRoleAddRepeated:           "role add error, same property in record",
		...
		ErrCodeValidateIp:                "ip format error",
